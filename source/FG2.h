...
//
// ******************************************
__global__ void PoincareSection(double4 *x4_d, double4 *v4_d, double4 *xold_d, double4 *vold_d, int *index_d, const double Msun, const int N, const int si, int *PFlag_d){
